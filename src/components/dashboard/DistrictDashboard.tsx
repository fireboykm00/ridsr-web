...
const DistrictDashboard: React.FC<DistrictDashboardProps> = ({ data }) => {
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h3 className="text-sm font-medium text-gray-600">Facilities with Cases</h3>
              <p className="text-2xl font-semibold text-gray-900">{data.facilitiesWithCases}</p>
            </div>
          </div>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="p-6">
          <h3 className="text-lg font-medium text-gray-900 mb-4">Top Diseases</h3>
          <div className="space-y-4">
            <div>
              <div className="flex justify-between mb-1">
                <span className="text-sm font-medium text-gray-700">Malaria</span>
            ...
            <div>
              <div className="flex justify-between mb-1">
                <span className="text-sm font-medium text-gray-700">Cholera</span>
            ...
            <div>
              <div className="flex justify-between mb-1">
                <span className="text-sm font-medium text-gray-700">SARI</span>
            ...
            <div>
              ...
              <div className="w-full bg-gray-200 rounded-full h-2.5">
                <div className="bg-gray-500 h-2.5 rounded-full" style={{ width: '15%' }}></div>
              </div>
            </div>
          </div>
        </Card>
