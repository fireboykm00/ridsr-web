...
import { Facility, User, FacilityType, RwandaDistrictType } from '@/types';
    ...
    const loadData = async () => {
      if (status === 'authenticated' && session) {
        try {
          ...
          const districtUsers = await userService.getUsersByDistrict(district);
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          <Card className="p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Facilities in {district}</h3>
